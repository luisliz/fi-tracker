...
export default {
  data() {
    return {
      ...
      fields: ['type', 'source', 'amount', 'date', 'show_details'],
      items: [
        {isActive: false, _showDetails: false, type: 'Dividends', source: 'VIG', amount: '$5802', date: '08/05/2020'},
        {isActive: false, _showDetails: false, type: 'Payment', source: 'Bank of America', amount: '$5802', date: '05/05/2020'},
        {isActive: false, _showDetails: false, type: 'Bonus', source: 'MSFT Entry Bonus', amount: '$5802', date: '05/05/2020'},
        {isActive: false, _showDetails: false, type: 'Vested Shares', source: 'MSFT', amount: '$5802', date: '05/05/2020'},
      ],
    }
  }
}
